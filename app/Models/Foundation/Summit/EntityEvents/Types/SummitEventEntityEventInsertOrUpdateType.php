...
/**
 * Class SummitEventEntityEventInsertOrUpdateType
 * @package Models\foundation\summit\EntityEvents
 */
final class SummitEventEntityEventInsertOrUpdateType extends SummitEventEntityEventType
{
    ...
    public function process()
    {
        ...
        if (!is_null($entity)) // if event exists its bc its published
        {
            ...
            (
                $published_current  && isset($metadata['pub_old']) && !$published_old ? 'INSERT' : $this->entity_event->getType()
            );
