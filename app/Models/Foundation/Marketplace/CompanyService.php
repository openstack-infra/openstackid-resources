 ...
 * @ORM\DiscriminatorMap({"CompanyService" = "CompanyService", "RegionalSupportedCompanyService" = "RegionalSupportedCompanyService", "OpenStackImplementation" = "OpenStackImplementation", "Appliance" = "Appliance", "Distribution" = "Distribution"})
