...
final class SummitService implements ISummitService
{
    ...
    )
    {
        ...
        return $this->tx_service->transaction(function() use($speaker,$presentation,$feedback) {
            ...
            if(!$presentation->AllowFeedBack)
                throw new ValidationException(sprintf("presentation id %s dont allow feedback", $presentation->ID));

            $attendee_id  = intval($feedback['owner_id']);
