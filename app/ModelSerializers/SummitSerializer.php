...
final class SummitSerializer extends SilverStripeSerializer
{
    ...
    public function serialize($expand = null, array $fields = array(), array $relations = array(), array $params = array())
    {
        ...
        $values['schedule_page_url']           = sprintf("%s%s/%s", Config::get("server.assets_base_url", 'https://www.openstack.org/'), $main_page, $schedule_page);
        $values['schedule_event_detail_url']   = sprintf("%s%s/%s/%s", Config::get("server.assets_base_url", 'https://www.openstack.org/'), $main_page, $schedule_page, 'events/:event_id/:event_title');
